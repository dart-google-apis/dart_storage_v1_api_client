...
abstract class Client extends ClientBase {
  core.String basePath = "/storage/v1/";
  ...
  BucketAccessControlsResource_ get bucketAccessControls => new BucketAccessControlsResource_(this);
  BucketsResource_ get buckets => new BucketsResource_(this);
  ChannelsResource_ get channels => new ChannelsResource_(this);
  DefaultObjectAccessControlsResource_ get defaultObjectAccessControls => new DefaultObjectAccessControlsResource_(this);
  ObjectAccessControlsResource_ get objectAccessControls => new ObjectAccessControlsResource_(this);
  ObjectsResource_ get objects => new ObjectsResource_(this);
